<?php
use KimSpeer\TryAlf\Components;
...
return [
    ...
    | By default all components from tryAlf are loaded in. You can
    ...
    */
    ...
    | for your app. By default all components from tryAlf are loaded in.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This value will set a prefix for all tryAlf components.
